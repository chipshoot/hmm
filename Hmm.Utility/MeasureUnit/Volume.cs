...
namespace Hmm.Utility.MeasureUnit
{
    ...
    public struct Volume : IComparable<Volume>
    {
        ...
        public double TotalMililiter => Math.Round(_value / 1000.0, Fractional);
        ...
        public static Volume FromMililiter(double value)
        {
