...
namespace Hmm.Api.Areas.HmmNote.Controllers
{
    ...
    public class AuthorController : ControllerBase
    {
        ...
        //[Authorize(Policy = HmmApiConstants.Policy.SubjectMustMatchAuthor)]
        ...
        public async Task<IActionResult> Get(string subject)
        {
            ...
            if (author == null)
            {
                ...
                var httpClient = _httpClientFactory.CreateClient(HmmApiConstants.HttpClient.Idp);
                ...
                var authorToCreate = new Author
                {
                    ...
                    Role = DomainEntity.Enumerations.AuthorRoleType.Guest,
                    IsActivated = true
                };
